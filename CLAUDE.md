...
**เหลือทำ:**
0. ⏳ **ยังไม่ push** — ตอนนี้ค้าง 3 commits (`6f487bb`, `12f0e7e`, ชีท A4) → เว็บจริงยังไม่มีทั้ง `/midterm` และ `/sheet` · kim สั่ง push เมื่อไหร่ค่อยขึ้น
1. ให้ kim รีวิวเว็บจริงทั้ง 6 สัปดาห์ + หน้า /midterm แล้วปรับตาม feedback
2. ❓ ฟังซ้ำ/ถามเพื่อน 2 จุดเสียงไม่ชัด (27:22, 31:56 ของไฟล์แนวข้อสอบ — ดูบรรทัด 📌 ข้างบน)
